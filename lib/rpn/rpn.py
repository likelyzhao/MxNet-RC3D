...
#    gt_boxes = bottom[1].data
    ...
    labels = labels.reshape((1, A *length*feat_height*feat_width))
    bbox_targets = bbox_targets.reshape((1, length, feat_height, feat_width, A * 2)).transpose(0, 4, 1, 2, 3)
    bbox_inside_weights = bbox_inside_weights.reshape((1, length, feat_height, feat_width, A * 2)).transpose((0, 4, 1, 2, 3))
    bbox_outside_weights = bbox_outside_weights.reshape((1, length, feat_height, feat_width, A * 2)).transpose((0, 4, 1, 2, 3))
