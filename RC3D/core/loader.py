...
from rpn.rpn import get_rpn_testbatch, get_rpn_batch, assign_anchor,get_twin_rpn_batch,assign_anchor_twin
...
class SegmentLoader(mx.io.DataIter):
    ...
    def __init__(self, feat_sym, roidb, cfg, batch_size=1, shuffle=False, ctx=None, work_load_list=None,
        ...
        self.size = len(roidb)
        self.index = np.arange(self.size)
        self.data_size = [config.network.LENGTH[0],config.network.CROP_SIZE,config.network.CROP_SIZE]
